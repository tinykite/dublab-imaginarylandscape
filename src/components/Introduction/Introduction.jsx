...
const Introduction = () => {
    ...
    <div className="Introduction">
      ...
      <p className="Introduction__text">As an early contribution to the documentation of electronic music and sound arts, Imaginary Landscape carries a definite contemporary relevance.</p> 
